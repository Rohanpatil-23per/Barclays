...
class SafetyVerifier:
        ...
        if result == sat:
            ...
            if is_restore_action and not backup_ok:
                ...
                substituted = ActionDecision(
                    ...
                    action_category   = get_action_category(47),
    ...
    def _is_trading_hours(self, timestamp: str) -> bool:
        ...
        try:
            dt_naive = datetime.fromisoformat(timestamp.rstrip("Z"))
            dt_ist   = pytz.utc.localize(dt_naive).astimezone(_IST)
...
if __name__ == "__main__":
    ...
    def _make_decision(
        ...
        return ActionDecision(
            ...
            action_category   = get_action_category(action_idx),
